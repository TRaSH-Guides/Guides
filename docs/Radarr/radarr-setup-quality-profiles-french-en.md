...
::: info This guide is created and maintained by [Someone Said "Nice"?](https://github.com/NiceTSY)

:::

::: tip Cette page est aussi disponible en Français : [Guide en Français](/Radarr/radarr-setup-quality-profiles-french-fr/).
...
::: info FlareSolverr?
Please refer to the [How to set up FlareSolverr](/Prowlarr/prowlarr-setup-flaresolverr/) section.
...
::: info Indexers - Replace MULTi by another language in release name option
...
::: info Indexers - Replace VOSTFR and SUBFRENCH with ENGLISH option
...
::: info Indexers - Replace VFQ with FRENCH
...
::: info Media Management - Standard Movie Format and Movie Folder Format
Please have a look there: [Recommended naming scheme](/Radarr/Radarr-recommended-naming-scheme/).
...
::: details VOSTFR + MULTi.VO Profile Screenshot - [Click to show/hide]
![UHD Bluray + WEB for VOSTFR or MULTi.VO Profile](images/french-radarr-qp-bluray-webdl-hd-vo.png)

:::

::: details MULTi.VF Profile Screenshot - [Click to show/hide]
...
A FAQ regarding most of the questions you could have is provided by TRaSH: [FAQ & Info](/Radarr/radarr-setup-quality-profiles/#faq-info)
