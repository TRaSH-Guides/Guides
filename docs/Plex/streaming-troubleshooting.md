...
remote-access path. [Tautulli](https://tautulli.com/)
and [Tracearr](https://tracearr.com/) both show you
...
([docs](https://docs.tautulli.com/)) is a monitoring
...
- **Decision** - `Direct Play`, `Direct Stream`, or `Transcode`. This is the single most useful
    ...
    and [Transcoding Media](https://support.plex.tv/articles/200250377-transcoding-media/)
...
[Tracearr](https://tracearr.com/)
([docs](https://docs.tracearr.com/)) is a
...
check [docs.tracearr.com](https://docs.tracearr.com/)
...
- [Why Is My Video Stream Buffering?](https://support.plex.tv/articles/201575036-why-is-my-video-stream-buffering/)
- [Streaming Overview](https://support.plex.tv/articles/200430303-streaming-overview/)
- [Streaming Media: Direct Play and Direct Stream](https://support.plex.tv/articles/200250387-streaming-media-direct-play-and-direct-stream/)
...
- [How Do Streaming Quality Selections Work?](https://support.plex.tv/articles/203810306-how-do-streaming-quality-selections-work/)
...
[Jellyfin](https://jellyfin.org/docs/). Kodi needs a
different approach since it's a client, not a server.

**Jellyfin** - the Dashboard's
[active devices/playback view](https://jellyfin.org/docs/general/server/devices/)
...
[Jellyfin FAQ](https://jellyfin.org/docs/general/faq/)
...
[advancedsettings.xml](https://kodi.wiki/view/Advancedsettings.xml)
controls buffer size and mode via the `<cache>` settings; see the wiki's
[video cache how-to](https://kodi.wiki/view/HOW-TO:Modify_the_video_cache)
