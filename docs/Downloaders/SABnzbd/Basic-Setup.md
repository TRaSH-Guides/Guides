...
!!! note "If you are using SABnzbd to download games and apps, this list shouldn't be used. You can either create a separate category for them, set it to download only, and manually extract the files, or use a separate app or instance for them."
