...
::: details mover-tuning-start.sh - [Click to show/hide]
...
::: details mover-tuning-end.sh - [Click to show/hide]
...
::: details mover-tuning.cfg - [Click to show/hide]
...
Download the latest qBit-Mover script [HERE](https://raw.githubusercontent.com/StuffAnThings/qbit_manage/master/scripts/mover.py).

Big thanks to [bobokun](https://github.com/bobokun), the developer of [qBit Manage](https://github.com/StuffAnThings/qbit_manage), for creating this script with all the requested changes.
...
On your USB stick/key, go to `/boot/config` and open the `go` file with your text editor ([VSCode](https://code.visualstudio.com/) or [Notepad++](https://notepad-plus-plus.org/downloads/)).
