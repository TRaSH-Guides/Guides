...
Follow the [How to import Custom Formats](/Radarr/Radarr-import-custom-formats/).
...
```json
<!--@include: @/json/guide-only/language-not-dutch.json-->
```
...
<sub>Language: Not Original or German<br>
...
```json
<!--@include: @/json/guide-only/language-not-original-or-german.json-->
```
...
```json
<!--@include: @/json/guide-only/language-prefer-german.json-->
```
...
<sub>Language: Prefer German</sub>
...
```json
<!--@include: @/json/guide-only/language-prefer-dutch.json-->
```
...
<sub>Language: German Dual Language</sub>

::: details JSON - [Click to show/hide]

```json
<!--@include: @/json/guide-only/language-german-and-original.json-->
```
...
::: details What's reverse scoring? - [Click to show/hide]
...
::: details Prefer language X over language Y - [Click to show/hide]
...
::: details What's Original Language? - [Click to show/hide]
...
::: details Where does Radarr get the Original Language from? - [Click to show/hide]

Radarr makes use of [The Movie Database (TMDB)](https://www.themoviedb.org/). As of February 12, 2023, Radarr has updated its metadata cache to use a movie's spoken language from TMDb as the original language, but only when there is a single spoken language listed for that movie on TMDb. In cases where multiple spoken languages are listed, Radarr will use the movie's designated original language from TMDb.

![!The Movie Database (TMDB) Original Language](../../Radarr/Tips/images/original-language-tmdb.png)

:::

### Where does Sonarr get the Original Language from

::: details Where does Sonarr get the Original Language from? - [Click to show/hide]

Sonarr makes use of [TheTVDB](https://thetvdb.com/).

![!TheTVDB Original Language](../../Radarr/Tips/images/original-language-tvdb.png)
