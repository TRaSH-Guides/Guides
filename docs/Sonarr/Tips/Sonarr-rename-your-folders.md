...
![!radarr-wrong-folder-name](../../Radarr/Tips/images/radarr-wrong-folder-name.png)
...
![!radarr-movie-editor](../../Radarr/Tips/images/radarr-movie-editor.png)

Once you are in "edit" mode, you can select the movie(s) whose folders you want to be renamed.

![!radarr-movie-editor-select](../../Radarr/Tips/images/radarr-movie-editor-select.png)
...
![!radarr-edit-selected-movies](../../Radarr/Tips/images/radarr-edit-selected-movies.png)

Choose the same (current) root folder for your selected movies, and choose `Apply Changes`.

![!radarr-movie-editor-move-files-yes](../../Radarr/Tips/images/radarr-movie-editor-move-files-yes.png)
...
![!radarr-correct-folder-name](../../Radarr/Tips/images/radarr-correct-folder-name.png)
