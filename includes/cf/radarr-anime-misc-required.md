...
::: details Miscellaneous (Required) - [Click to show/hide]
...
| [{{ radarr['cf']['repack2']['name'] }}](/Radarr/Radarr-collection-of-custom-formats/#repack2)            |    {{ radarr['cf']['repack2']['trash_scores']['anime-radarr'] }}    | {{ radarr['cf']['repack2']['trash_id'] }}       |
| [{{ radarr['cf']['repack3']['name'] }}](/Radarr/Radarr-collection-of-custom-formats/#repack3)            |    {{ radarr['cf']['repack3']['trash_scores']['anime-radarr'] }}    | {{ radarr['cf']['repack3']['trash_id'] }}       |
