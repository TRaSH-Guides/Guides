...
::: details Miscellaneous Anime (Optional) - [Click to show/hide]
...
| [{{ radarr['cf']['not-german-japanese-korean-chinese-or-english']['name'] }}](/Radarr/Radarr-collection-of-custom-formats/#not-german-japanese-korean-chinese-or-english) | {{ radarr['cf']['not-german-japanese-korean-chinese-or-english']['trash_scores']['default'] }} | {{ radarr['cf']['not-german-japanese-korean-chinese-or-english']['trash_id'] }} |
...
- **{{ radarr['cf']['not-german-japanese-korean-chinese-or-english']['name'] }}:** [*Optional*] This custom format is used to avoid releases which do not contain German, Japanese, Korean, Chinese or English audio. You can utilize it to get animated media from other East Asian countries. :warning: If this `CF` is used, `{{ radarr['cf']['not-german-japanese-or-english']['name'] }}` must be `0`.
