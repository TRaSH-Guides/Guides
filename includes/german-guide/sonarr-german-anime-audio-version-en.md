...
??? abstract "German Anime Audio - [Click to show/hide]"
    ...
    | [{{ sonarr['cf']['german-subbed']['name'] }}](/Sonarr/sonarr-collection-of-custom-formats/#language-german-subbed)                                            | {{ sonarr['cf']['german-subbed']['trash_scores']['default'] }}                           | {{ sonarr['cf']['german-subbed']['trash_id'] }}                           |
