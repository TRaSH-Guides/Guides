...
??? abstract "German Anime Audio - [Click to show/hide]"
    ...
    | [{{ sonarr['cf']['german-anime-subbed']['name'] }}](/Sonarr/sonarr-collection-of-custom-formats/#language-german-anime-subbed) | {{ sonarr['cf']['german-anime-subbed']['trash_scores']['default'] }}  | {{ sonarr['cf']['german-anime-subbed']['trash_id'] }}  |
