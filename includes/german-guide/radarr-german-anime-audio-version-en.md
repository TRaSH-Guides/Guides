...
::: details German Anime Audio - [Click to show/hide]
...
- **{{ radarr['cf']['not-german-japanese-or-english']['name'] }}:** This custom format is used to avoid releases which do not contain German, Japanese or English audio.
- **{{ radarr['cf']['german-subbed']['name'] }}:** Used to recognize German (and possibly English) subtitles.
