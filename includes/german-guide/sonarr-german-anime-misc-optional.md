...
| [{{ sonarr['cf']['not-german-japanese-korean-chinese-or-english']['name'] }}](/Sonarr/sonarr-collection-of-custom-formats/#not-german-japanese-korean-chinese-or-english) | {{ sonarr['cf']['not-german-japanese-korean-chinese-or-english']['trash_scores']['default'] }} | {{ sonarr['cf']['not-german-japanese-korean-chinese-or-english']['trash_id'] }} |
...
- **{{ sonarr['cf']['not-german-japanese-korean-chinese-or-english']['name'] }}:** [*Optional*] This custom format is used to avoid releases which do not contain German, Japanese, Korean, Chinese or English audio. You can utilize it to get animated media from other East Asian countries. :warning: If this `CF` is used, `{{ sonarr['cf']['not-german-japanese-or-english']['name'] }}` must be `0`.
