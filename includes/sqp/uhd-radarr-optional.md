??? summary "Optional - [CLICK TO EXPAND]"
    ...
    - **{{ radarr['cf']['evo-no-webdl']['name'] }}:** [*Optional*] This group is often banned for the low quality Blu-ray releases, but their WEB-DL are okay.
    - **{{ radarr['cf']['x265-no-hdrdv']['name'] }}:** [*Optional*] This blocks 720/1080p (HD) releases that are encoded in x265. - More info [HERE](/Misc/x265-4k/){:target="_blank" rel="noopener noreferrer"}.
    ...
    - **{{ radarr['cf']['dv-webdl']['name'] }}:** [*Optional*] This is a special Custom Format that Block WEBDL with Dolby Vision but without HDR10 fallback.
