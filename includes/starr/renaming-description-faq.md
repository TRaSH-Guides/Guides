...
::: details Why should I include extra information in filenames?
...
::: details What's non-recoverable information and can't be recovered later?
...
::: details Why is the non-recoverable information important/needed?
...
::: details Don't Plex, Emby, and Jellyfin work fine with simple names like `movie (year).ext`/`tv showname SxxExx.ext`?
...
::: details Why are the recommended filenames so long?
