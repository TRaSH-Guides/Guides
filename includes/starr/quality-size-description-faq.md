...
::: details Why do i only see sizes starting from HDTV720p and up?
...
::: details Why are some sizes set to max?

- These guides are created to achieve the highest possible quality based on the quality profiles provided.

:::

::: details Why is there a difference between regular movies/tv shows and anime/animated/cartoons ?
...
::: details When I set Bluray to MAX size I often get ISO's/ Bluray folder structure.

- You have probably configured your Quality Profiles incorrectly by enabling BR-DISK without adding the recommended Custom Format for Radarr to block/ignore [BR-DISK](/Radarr/Radarr-collection-of-custom-formats/#br-disk). For Sonarr, you can use the following to block/ignore [BR-DISK](/Sonarr/sonarr-collection-of-custom-formats/#br-disk).

:::

::: details Some movies or episodes may not be grabbed due to these settings.
